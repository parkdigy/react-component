...
var PIcon = function PIcon(t0) {
  ...
  var t5;
  if ($[17] !== resetStyleFontSize || $[18] !== size) {
    t5 = function t5() {
      if (!compare.contains(NamedFontSize, size)) {
        resetStyleFontSize();
      }
  ...
  reactHook.useEventLayoutEffect(t5, t6);
  var t7;
  ...
  if (InitChildren === undefined) {
    ...
    var t11;
    if ($[33] !== contentIconRef || $[34] !== finalColor || $[35] !== iconFontSize || $[36] !== props || $[37] !== style || $[38] !== t10 || $[39] !== _t2) {
      t11 = /*#__PURE__*/React.createElement(material.Icon, _extends({
        ref: contentIconRef,
  ...
  if ($[41] !== content || $[42] !== tooltip || $[43] !== tooltipPlacement || $[44] !== tooltipProps) {
    t9 = !content ? null : tooltip ? /*#__PURE__*/React.createElement(material.Tooltip, _extends({
      title: tooltip,
