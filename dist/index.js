'use strict';var compilerRuntime=require('react/compiler-runtime'),React=require('react'),material=require('@mui/material'),classNames=require('classnames'),compare=require('@pdg/compare'),formatting=require('@pdg/formatting'),dayjs=require('dayjs'),copy=require('copy-to-clipboard');function _arrayLikeToArray(r, a) {
...
var PIcon = function PIcon(t0) {
    ...
    var _useState = React.useState(), _useState2 = _slicedToArray(_useState, 2), styleFontSize = _useState2[0], setStyleFontSize = _useState2[1];
    var t1;
    if ($[11] !== size) {
        t1 = compare.contains(NamedSizes, size);
        $[11] = size;
        $[12] = t1;
    }
    else {
    ...
    var finalColor = compare.contains(MuiColors, color) ? color : undefined;
    ...
    if ($[31] !== computedIconFontSize || $[32] !== finalColor || $[33] !== props || $[34] !== style || $[35] !== t10 || $[36] !== t8 || $[37] !== t9) {
        t11 = /*#__PURE__*/ React.createElement(material.Icon, _extends({}, props, {
            ref: t8,
    ...
    if ($[39] !== content || $[40] !== tooltip || $[41] !== tooltipPlacement || $[42] !== tooltipProps) {
        t12 = tooltip ? /*#__PURE__*/ React.createElement(material.Tooltip, _extends({
            title: tooltip,
...
var PBox = function PBox(t0) {
    ...
    if ($[30] !== marginPaddingSizeProps || $[31] !== otherProps) {
        t12 = /*#__PURE__*/ React.createElement(material.Box, _extends({}, marginPaddingSizeProps, otherProps));
...
var PText = function PText(t0) {
    ...
    if ($[47] !== children || $[48] !== props || $[49] !== t20 || $[50] !== t21) {
        t22 = /*#__PURE__*/ React.createElement(material.Typography, _extends({
            display: t20,
            className: t21
        }, props), children);
        $[47] = children;
...
var PBusinessNoText = function PBusinessNoText(t0) {
    ...
    if ($[5] !== children || $[6] !== value) {
        var _ref;
        t1 = formatting.formatBusinessNo((_ref = children !== null && children !== void 0 ? children : value) !== null && _ref !== void 0 ? _ref : "").substring(0, 12);
        $[5] = children;
        $[6] = value;
        $[7] = t1;
    }
...
var PButton = function PButton(t0) {
    ...
    var style = t9;
    var color = compare.contains(NamedColors$1, initColor) ? initColor : undefined;
    var t10;
    ...
    if ($[69] !== color || $[70] !== disabled || $[71] !== props || $[72] !== size || $[73] !== style || $[74] !== sx || $[75] !== t21 || $[76] !== t25 || $[77] !== variant) {
        t26 = /*#__PURE__*/ React.createElement(material.Button, _extends({
            variant: variant,
            size: size,
            color: color,
            disabled: disabled,
    ...
    if ($[79] !== content || $[80] !== tooltip || $[81] !== tooltipPlacement || $[82] !== tooltipProps) {
        t27 = tooltip ? /*#__PURE__*/ React.createElement(material.Tooltip, _extends({
            title: tooltip,
            placement: tooltipPlacement !== null && tooltipPlacement !== void 0 ? tooltipPlacement : "top",
            arrow: true
        }, tooltipProps), content) : content;
...
var PIconButton = function PIconButton(t0) {
    ...
    var color = compare.contains(NamedColors, initColor) ? initColor : undefined;
...
function _temp(acc, t0) {
    var _t2 = _slicedToArray(t0, 2), key = _t2[0], value = _t2[1];
    if (value == null) {
        return acc;
    }
    var formattedValue;
...
var PCopyToClipboard = function PCopyToClipboard(_ref) {
    var text = _ref.text, options = _ref.options, children = _ref.children, onCopy = _ref.onCopy, props = _objectWithoutProperties(_ref, _excluded);
    /********************************************************************************************************************
     * Event Handler
     * ******************************************************************************************************************/
