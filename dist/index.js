...
var PIcon = function PIcon(t0) {
  ...
  if (reactHook.useChanged(t3)) {
    if (compare.contains(NamedFontSize, size)) {
      setStyleFontSize(undefined);
    }
  }
  var t4;
  if ($[16] !== resetStyleFontSize || $[17] !== size) {
    t4 = function t4() {
      if (!compare.contains(NamedFontSize, size)) {
        resetStyleFontSize();
      }
    };
    $[16] = resetStyleFontSize;
    $[17] = size;
    $[18] = t4;
  } else {
    t4 = $[18];
  ...
  reactHook.useEventLayoutEffect(t4, t5);
  var t6;
  if ($[20] !== ref || $[21] !== resetStyleFontSize) {
    t6 = function t6(r) {
      if (ref) {
  ...
  if (InitChildren === undefined) {
    ...
    var finalColor;
    var style;
    if ($[23] !== color || $[24] !== initStyle || $[25] !== styleFontSize) {
      style = _objectSpread2({}, initStyle);
      if (styleFontSize != null) {
        style.fontSize = styleFontSize;
      }
      finalColor = compare.contains(NamedColor$2, color) ? color : undefined;
    ...
    var t10;
    if ($[32] !== contentIconRef || $[33] !== finalColor || $[34] !== iconFontSize || $[35] !== props || $[36] !== style || $[37] !== _t2 || $[38] !== t9) {
      t10 = /*#__PURE__*/React.createElement(material.Icon, _extends({
        ref: contentIconRef,
  ...
  var content = t7;
  var t8;
  if ($[40] !== content || $[41] !== tooltip || $[42] !== tooltipPlacement || $[43] !== tooltipProps) {
    t8 = !content ? null : tooltip ? /*#__PURE__*/React.createElement(material.Tooltip, _extends({
      title: tooltip,
...
var PButton = function PButton(t0) {
  ...
  var style = newStyle;
  var color = compare.contains(NamedColor$1, initColor) ? initColor : undefined;
  var t2;
  if ($[31] !== className) {
