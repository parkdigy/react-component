'use strict';var compilerRuntime=require('react/compiler-runtime'),React=require('react'),material=require('@mui/material'),classNames=require('classnames'),compare=require('@pdg/compare'),reactHook=require('@pdg/react-hook'),formatting=require('@pdg/formatting'),dayjs=require('dayjs'),copy=require('copy-to-clipboard');function _arrayLikeToArray(r, a) {
...
var PIcon = function PIcon(t0) {
  ...
  var iconFontSize = compare.contains(NamedFontSize, size) ? size : undefined;
  var t2;
  ...
  if ($[14] !== resetStyleFontSize) {
    t3 = function t3(s) {
      if (compare.contains(NamedFontSize, s)) {
        setStyleFontSize(undefined);
      } else {
        resetStyleFontSize();
      }
  ...
  reactHook.useChange(size, t3);
  var t4;
  if ($[16] !== ref || $[17] !== resetStyleFontSize) {
    t4 = function t4(r) {
      if (ref) {
    ...
    $[16] = ref;
    $[17] = resetStyleFontSize;
    $[18] = t4;
  } else {
    t4 = $[18];
  }
  var contentIconRef = t4;
  var t5;
  if (InitChildren === undefined) {
    ...
    var finalColor;
    var style;
    if ($[19] !== color || $[20] !== initStyle || $[21] !== styleFontSize) {
      style = _objectSpread2({}, initStyle);
      if (styleFontSize != null) {
        style.fontSize = styleFontSize;
      }
      finalColor = compare.contains(NamedColor$1, color) ? color : undefined;
    ...
    var t7;
    if ($[26] !== InitChildren) {
      t7 = typeof InitChildren === "string" ? InitChildren.replace(/[A-Z]/g, _temp$1) : /*#__PURE__*/React.createElement(InitChildren, null);
      $[26] = InitChildren;
      $[27] = t7;
    } else {
      t7 = $[27];
    ...
    var t8;
    if ($[28] !== contentIconRef || $[29] !== finalColor || $[30] !== iconFontSize || $[31] !== props || $[32] !== style || $[33] !== _t2 || $[34] !== t7) {
      t8 = /*#__PURE__*/React.createElement(material.Icon, _extends({
        ref: contentIconRef,
  ...
  var content = t5;
  var t6;
  if ($[36] !== content || $[37] !== tooltip || $[38] !== tooltipPlacement || $[39] !== tooltipProps) {
    t6 = !content ? null : tooltip ? /*#__PURE__*/React.createElement(material.Tooltip, _extends({
      title: tooltip,
...
var PBox = function PBox(t0) {
  ...
  var t1;
  if ($[18] !== props) {
    t1 = /*#__PURE__*/React.createElement(material.Box, props);
    $[18] = props;
    $[19] = t1;
  } else {
    t1 = $[19];
...
var PText = function PText(t0) {
  ...
  bb2: {
    ...
    if ($[38] !== children || $[39] !== props || $[40] !== t4 || $[41] !== t5) {
      t6 = /*#__PURE__*/React.createElement(material.Typography, _extends({
        display: t4,
        className: t5
      }, props), children);
      $[38] = children;
...
var PBusinessNoText = function PBusinessNoText(t0) {
  ...
  var t1;
  if ($[5] !== finalValue) {
    t1 = formatting.formatBusinessNo(finalValue).substring(0, 12);
    $[5] = finalValue;
    $[6] = t1;
  } else {
    t1 = $[6];
...
var PNumberText = function PNumberText(t0) {
  ...
  var t1;
  if ($[10] !== value) {
    t1 = value != null ? formatting.formatNumber(value).split(".") : null;
    $[10] = value;
    $[11] = t1;
  } else {
    t1 = $[11];
...
var StyledPrefix = material.styled('span')(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n  margin-right: 2px;\n"])));
var StyledSuffix = material.styled('span')(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n  margin-left: 2px;\n"])));var _excluded$9 = ["children", "value", "className"];
var PPersonalNoText = function PPersonalNoText(t0) {
  ...
  var t1;
  if ($[5] !== finalValue) {
    t1 = formatting.formatPersonalNo(finalValue).substring(0, 14);
    $[5] = finalValue;
    $[6] = t1;
  } else {
    t1 = $[6];
...
var PTelText = function PTelText(t0) {
  ...
  var t1;
  if ($[5] !== finalValue) {
    t1 = formatting.formatTelNo(finalValue);
    $[5] = finalValue;
    $[6] = t1;
  } else {
    t1 = $[6];
...
var PButton = function PButton(t0) {
  ...
  var style = newStyle;
  var color = compare.contains(["inherit", "primary", "secondary", "error", "info", "success", "warning"], initColor) ? initColor : undefined;
  var t2;
  if ($[31] !== className) {
  ...
  if ($[63] !== color || $[64] !== disabled || $[65] !== props || $[66] !== size || $[67] !== style || $[68] !== t2 || $[69] !== t3 || $[70] !== t9 || $[71] !== variant) {
    t10 = /*#__PURE__*/React.createElement(material.Button, _extends({
      variant: variant,
      size: size,
      color: color,
      disabled: disabled,
  ...
  if ($[73] !== content || $[74] !== tooltip || $[75] !== tooltipPlacement || $[76] !== tooltipProps) {
    t11 = tooltip ? /*#__PURE__*/React.createElement(material.Tooltip, _extends({
      title: tooltip,
      placement: tooltipPlacement,
      arrow: true
    }, tooltipProps), content) : content;
...
var PIconButton = function PIconButton(t0) {
  ...
  var tooltipPlacement = t1 === undefined ? "top" : t1;
  var color = compare.contains(NamedColor, initColor) ? initColor : undefined;
  var t2;
  if ($[13] !== className) {
  ...
  if ($[26] !== color || $[27] !== props || $[28] !== size || $[29] !== t2 || $[30] !== t5 || $[31] !== t9) {
    t10 = /*#__PURE__*/React.createElement(material.IconButton, _extends({
      color: color,
      className: t2,
      size: size,
      sx: t5
...
var StyledBox = material.styled(material.Box)(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n  margin-top: 20px;\n  font-size: 13px;\n  border: 1px solid black;\n  background-color: black;\n  color: #fff;\n  padding: 10px 13px;\n  opacity: 0.7;\n"])));
...
var PCopyToClipboard = function PCopyToClipboard(t0) {
  ...
  return t3;
};exports.PBox=PBox;exports.PBusinessNoText=PBusinessNoText;exports.PButton=PButton;exports.PCopyToClipboard=PCopyToClipboard;exports.PDateText=PDateText;exports.PEmailText=PEmailText;exports.PFlex=PFlex;exports.PFlexColumnBox=PFlexColumnBox;exports.PFlexRowBox=PFlexRowBox;exports.PHelper=PHelper;exports.PIcon=PIcon;exports.PIconButton=PIconButton;exports.PIconText=PIconText;exports.PNumberText=PNumberText;exports.PPersonalNoText=PPersonalNoText;exports.PReactCode=PReactCode;exports.PStack=PStack;exports.PTelText=PTelText;exports.PText=PText;exports.PWonText=PWonText;