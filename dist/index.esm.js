import React,{useMemo}from'react';import {useTheme,Typography,Icon,Box,styled,Button,IconButton}from'@mui/material';import classNames from'classnames';import {companyNoAutoDash,ifUndefined,numberFormat,personalNoAutoDash,telNoAutoDash}from'@pdg/util';import dayjs from'dayjs';/******************************************************************************
...
typeof SuppressedError === "function" ? SuppressedError : function (error, suppressed, message) {
    ...
    return React.createElement(Typography, __assign({ className: classNames('PdgText', className), display: 'inline-block' }, props));
};/********************************************************************************************************************
...
var PdgIcon = React.forwardRef(function (_a, ref) {
    ...
    var fontSize = useMemo(function () { return (size === undefined || typeof size === 'string' ? size : undefined); }, [size]);
    ...
    return useMemo(function () {
        ...
        return typeof InitChildren === 'string' ? (React.createElement(Icon, __assign({ ref: ref, fontSize: fontSize }, iconProps), InitChildren.replace(/[A-Z]/g, function (letter, idx) { return "".concat(idx > 0 ? '_' : '').concat(letter.toLowerCase()); }))) : (React.createElement(InitChildren, __assign({}, iconProps)));
...
var PdgIconText = function (_a) {
     ...
     * Render
     * ******************************************************************************************************************/
    return (React.createElement(Box, __assign({ display: 'inline-flex', alignItems: 'center', className: classNames('PdgIconText', className), fontSize: fontSize }, otherProps),
...
var PdgWonText = function (_a) {
    ...
    return (React.createElement(Button, __assign({ ref: ref, size: size, className: classNames(className, 'PdgButton') }, props),
        React.createElement(Box, { display: 'inline-flex', flexDirection: 'row', alignItems: 'center' },
            ...
            React.createElement(Typography, { style: { fontSize: fontSize } }, children),
...
PdgButton.displayName = 'PdgButton';var PdgIconButton = function (_a) {
    ...
    return (React.createElement(IconButton, __assign({ className: classNames('PdgIconButton', className), size: size }, props),
        React.createElement(PdgIcon, __assign({}, iconProps, { size: ifUndefined(iconSize, size), className: classNames('PdgIconButton-Icon', iconProps === null || iconProps === void 0 ? void 0 : iconProps.className) }), children)));
};export{PdgButton,PdgCompanyNoText,PdgDateText,PdgEmailText,PdgIcon,PdgIconButton,PdgIconText,PdgNumberText,PdgPersonalNoText,PdgTelText,PdgText,PdgWonText};