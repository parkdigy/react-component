import {c}from'react/compiler-runtime';import React,{useRef,useState}from'react';import {Icon,Tooltip,Box,useTheme,Typography,styled,darken,Button,IconButton}from'@mui/material';import classNames from'classnames';import {contains}from'@pdg/compare';import {useChange}from'@pdg/react-hook';import {formatBusinessNo,formatNumber,formatPersonalNo,formatTelNo}from'@pdg/formatting';import dayjs from'dayjs';import copy from'copy-to-clipboard';function _arrayLikeToArray(r, a) {
...
var PIcon = function PIcon(t0) {
  ...
  if (InitChildren === undefined) {
    ...
    if ($[28] !== contentIconRef || $[29] !== finalColor || $[30] !== iconFontSize || $[31] !== props || $[32] !== style || $[33] !== _t2 || $[34] !== t7) {
      t8 = /*#__PURE__*/React.createElement(Icon, _extends({
        ref: contentIconRef,
  ...
  if ($[36] !== content || $[37] !== tooltip || $[38] !== tooltipPlacement || $[39] !== tooltipProps) {
    t6 = !content ? null : tooltip ? /*#__PURE__*/React.createElement(Tooltip, _extends({
      title: tooltip,
