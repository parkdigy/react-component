...
var templateObject_1;var PdgFlex = React.forwardRef(function (_a, ref) {
    ...
    return (React.createElement(Box, __assign({ ref: ref, className: classNames('PdgFlex', className), component: 'div', display: 'flex', flexDirection: row ? 'row' : 'column', alignItems: ifUndefined(alignItems, alignCenter ? 'center' : undefined), justifyContent: ifUndefined(justifyContent, justifyCenter ? 'center' : undefined), gap: ifUndefined(gap, spacing) }, props)));
    ...
    return (React.createElement(Box, __assign({ ref: ref, className: classNames('PdgFlexColumnBox', className), component: 'div', display: 'flex', flexDirection: 'column', alignItems: ifUndefined(alignItems, center ? 'center' : undefined), justifyContent: ifUndefined(justifyContent, centerVertical ? 'center' : undefined), gap: ifUndefined(gap, spacing) }, props)));
});export{PdgButton$1 as PdgButton,PdgCompanyNoText$1 as PdgCompanyNoText,PdgDateText$1 as PdgDateText,PdgEmailText$1 as PdgEmailText,PdgFlex,PdgFlexColumnBox,PdgFlexRowBox,PdgHelper,PdgIcon$1 as PdgIcon,PdgIconButton$1 as PdgIconButton,PdgIconText$1 as PdgIconText,PdgNumberText$1 as PdgNumberText,PdgPersonalNoText$1 as PdgPersonalNoText,PdgReactCode,PdgTelText$1 as PdgTelText,PdgText$1 as PdgText,PdgWonText$1 as PdgWonText};