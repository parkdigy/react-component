...
const PNumberText = React.forwardRef<HTMLSpanElement, Props>(
  (
    ...
    return integerValue != undefined ? (
      <PText ref={ref} className={classNames('PNumberText', className)} {...props}>
        {prefix !== undefined && (
          <StyledPrefix
...
export default React.memo(PNumberText);
