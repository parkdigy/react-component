...
import { Texts_PEmailTextProps as Props } from './Texts_PEmailText.types';
import {
  ControlBar,
  ControlBarRow,
...
export const Texts_PEmailText: React.FC<Props> = () => {
  ...
  return (
    <div>
      ...
      <PEmailText value={finalValue} color={color} size={size} helper={helperProps} />

      <PReactCode name='PEmailText' props={{ value: finalValue, size, color, helper: helperProps }} />
      <PReactCode
        name='PEmailText'
        content={finalValue}
        props={{
